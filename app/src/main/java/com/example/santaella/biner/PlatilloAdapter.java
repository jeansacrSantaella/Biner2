...
public class PlatilloAdapter extends ArrayAdapter {
    private Context context;
    private ArrayList<Platillo> datos;

    public PlatilloAdapter(@NonNull Context context, ArrayList datos) {
        super(context, R.layout.fila_lista,datos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // nombre.
        TextView nombre = (TextView) item.findViewById(R.id.texto_principal);
